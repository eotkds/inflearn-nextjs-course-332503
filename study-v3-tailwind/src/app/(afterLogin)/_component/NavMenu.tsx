          ...
          <div className={style.navPill}>
            {segment === 'home' ?
              <>
                ...
                <div className='font-bold hidden xl:block'>홈</div>
              </> :
              <>
                <svg width={26} viewBox="0 0 24 24" aria-hidden="true"
                     className="r-18jsvk2 r-4qtqp9 r-yyyyoo r-lwhw9o r-dnmrzs r-bnwqim r-1plcrui r-lrvibr r-cnnz9e">
                ...
                <div className='hidden xl:block'>홈</div>
              </>}
          </div>
        </Link>
      </li>
          ...
          <div className={style.navPill}>
            {segment && (['search', 'explore'].includes(segment)) ?
              <>
                ...
                <div className='font-bold hidden xl:block'>탐색하기</div>
              </> :
              <>
                <svg width={26} viewBox="0 0 24 24" aria-hidden="true"
                     className="r-18jsvk2 r-4qtqp9 r-yyyyoo r-lwhw9o r-dnmrzs r-bnwqim r-1plcrui r-lrvibr r-cnnz9e">
                ...
                <div className='hidden xl:block'>탐색하기</div>
              </>
            }
          </div>
        </Link>
          ...
          <div className={style.navPill}>
            {segment === 'messages' ?
              <>
                ...
                <div className='font-bold hidden xl:block'>쪽지</div>
              </> :
              <>
                <svg width={26} viewBox="0 0 24 24" aria-hidden="true"
                     className="r-18jsvk2 r-4qtqp9 r-yyyyoo r-lwhw9o r-dnmrzs r-bnwqim r-1plcrui r-lrvibr r-cnnz9e">
                ...
                <div className='hidden xl:block'>쪽지</div>
              </>}
          </div>
        </Link>
      </li>
        ...
        <Link href={`/${me?.id}`}>
          <div className={style.navPill}>
            {segment === me.id ? <>
                ...
                <div className='font-bold hidden xl:block'>프로필</div>
              </> :
              <>
                <svg width={26} viewBox="0 0 24 24" aria-hidden="true"
                     className="r-18jsvk2 r-4qtqp9 r-yyyyoo r-lwhw9o r-dnmrzs r-bnwqim r-1plcrui r-lrvibr r-cnnz9e">
                ...
                <div className='hidden xl:block'>프로필</div>
              </>}
          </div>
        </Link>
      </li>}
