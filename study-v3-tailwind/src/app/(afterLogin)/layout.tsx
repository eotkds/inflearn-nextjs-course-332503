            ...
            {session?.user && (
              <>
                <nav className="flex-1">
                  ...
                  <Link
                    href="/compose/tweet/"
                    className="flex items-center justify-center h-[50px] w-[50px] text-white font-bold text-[17px] rounded-[50%] bg-[rgb(29,155,240)] hover:bg-[rgb(26,140,216)] shadow-[0_8px_28px_rgba(0,0,0,0.08)] xl:w-[234px] xl:h-[42px] xl:rounded-[26px] xl:mx-[16px]"
                  >
                    <span className="hidden xl:inline-block">게시하기</span>
                    <svg
                      viewBox="0 0 24 24"
                      aria-hidden="true"
                      className="r-jwli3a r-4qtqp9 r-yyyyoo r-1472mwg r-dnmrzs r-bnwqim r-1plcrui r-lrvibr r-lrsllp inline-block fill-white w-[24px] xl:hidden"
                    >
                      <g>
